...
The big question here is: What does that mean? Where does the decision come from if it does not arise in the brain as electrical patterns of neurons firing in the brain? Do we have free will? And if not, how does it change the idea of changing yourself to become a "better" person?
