  ...
  return (
    ...
    >
      ...
      <div className="tracking-wider">
        ...
        <span className="text-green-200">@/pages/_app</span>
        <br />
        The canvas is configured in{" "}
        <span className="text-green-200">@/components/canvas/Scene</span>
        <br />
        Update your index component in{" "}
        <span className="text-green-200">@/pages/index</span>
        <br />
        Delete placeholder pages{" "}
        <span className="text-red-200"> @/pages/blob</span>
        <br />
        Delete{" "}
        <span className="text-red-200"> @/components/dom/Instructions</span>
        <br />
        Delete <span className="text-red-200">
          {" "}
          @/components/canvas/Blob
        </span> & <span className="text-red-200">/Logo</span>
      </div>
    </div>
  );
}
