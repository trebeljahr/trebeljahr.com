...
export function NiceCard({
  ...
  return (
    <Link
      href={slug}
      className="primary-bright dark:primary-dark block overflow-hidden mb-12 lg:mb-12 no-underline prose-headings:text-inherit transform transition-transform duration-300 hover:scale-[1.02] shadow-lg rounded-lg"
    >
      <div
        key={slug}
        className="md:grid "
