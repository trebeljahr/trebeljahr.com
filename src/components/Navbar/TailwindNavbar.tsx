    ...
    <Disclosure>
      {({ open, close }) => (
        <div className="prose-a:no-underline prose-a:hover:text-inherit prose-a:font-normal font-normal prose-a:text-inherit">
          <DisclosureButton
            className={clsx(
              "fixed top-2 z-50 bg-white dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center rounded-full p-3 ",
          ...
          <DisclosurePanel className="absolute z-40 top-0 left-0 py-2 w-[220px] h-screen  bg-white dark:bg-gray-900">
