...
The mag method is short for magnitude which is just mathematical jargon for getting the length of a vector. This is also called the "Norm" of a vector. 

If you imagine the vector giving you a location in space you could say, hmmm, if I were to walk there, how long would I have to walk? The answer to that can be easily found out by using the Pythagorean theorem. 
