...
And answer the question of "what do we need all this math for" beautifully. This post is a deep dive into one of those solutions. The SAT algorithm.
...
Triangulating Polygons is a tough problem because there are so many weird edge cases to deal with. There have been whole papers written about how to efficiently do it (see [resources](#triangulation) below) and I won't go into too much detail here, and neither will I attempt to fix all the possible edge cases. 
