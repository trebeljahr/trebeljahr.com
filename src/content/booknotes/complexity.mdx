...
Humans don't respond to economic incentives the way the economists would want them to. We are an irrational bunch. This brings to mind quite a few books [Dan Ariely's Predictably Irrational](/booknotes/predictably-irrational) as well as [Daniel Kahnemanns Thinking Fast and Thinking Slow](/booknotes/thinking-fast-and-slow) and [Jonathan Haidts The Righteous Mind](/booknotes/the-righteous-mind) and of course also [Nassim Taleb's The Black Swan](/booknotes/black-swan). All of them deal with very similar ideas, how markets don't behave the way economist used to think they would, because humans are far from being rational, we have lots and lots of biases influencing our thinking, putting it far far away from the optimal choice in most cases. 
...
**Book Recommendation:** Order out of Chaos – Ilya Prigogines
...
The idea of lockins chosen at random from lucky chance breaks reminds me a lot of the idea of Evolutionarily Stable Strategies from [The Selfish Gene](/booknotes/the-selfish-gene).
...
Researcher: [Stuart Kaufmann](https://en.wikipedia.org/wiki/Stuart_Kauffman)
...
The idea of networks based on switches transcends genes and neurons and computers. That's one part where complexity theory shows, where it is substrate independent, just like computation and informational storage. See [Max Tegmark Life 3.0](/booknotes/life-3-0)
...
Lookup: [A Logical Calculus of the Ideas Immanent in Nervous Activity - Warren MCCulloch](https://sci-hub.hkvisa.net/10.1007/bf02478259)
...
The Global Economy as an Adaptive Process by John H. Holland – couldn't quite find that talk specifically, however found [this more modern talk instead](https://www.youtube.com/watch?v=3httLyRCCuM). 

There is also [this paper on Complex Adaptive Systems by John Holland](https://sci-hub.ru/https://www.jstor.org/stable/20025416) which came up with in Google.
...
There it is again, this word, unfold, evolution is a continual unfolding of conplexity. This idea reminds me a lot of [The Evolution of Everything](/booknotes/the-evolution-of-everything). 
...
Paper describing the idea of a von Neumann architecture - [Preliminary Discussion of the Logical Design of an Electronic Computing Instrument](https://sci-hub.ru/https://link.springer.com/chapter/10.1007/978-3-642-61812-3_32)

Another thing to read: [Cycles in Logical Nets](https://sci-hub.hkvisa.net/10.1016/0016-0032(60)90590-1)

**Book Recommendation:** Das Glasperlenspiel – Herman Hesse
...
Another technical paper: [A Logical Theory of Adaptive Systems Informally Described](https://sci-hub.hkvisa.net/10.1145/321127.321128)
...
[The Evolution of Belief - Paper by Chris Langton](https://www.gwern.net/docs/ai/1992-langton-artificiallife-2.pdf)
...
Life is between order and chaos - [Jordan Peterson has it eerily right in his book 12 Rules for Life](/booknotes/12-rules-for-life) he comes from a different place of reasoning but arrives at the very same conclusion. 
...
[Paper: Complex Adaptive Systems and Spontaneous Emergence by John Holland](https://sci-hub.ru/https://link.springer.com/chapter/10.1007/978-3-642-50007-7_3)
...
See also [Richard Dawkins book "The Selfish Gene"](/booknotes/the-selfish-gene) for a much more extended discussion of this topic. 
...
**Book Recommendation:**  Santa Fe Institute Book on Complexity – Chris Langton
...
**Book Recommendation:** Frankenstein – Mary Shelley
