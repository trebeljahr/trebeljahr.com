...
[Glycemic Index](#TODO) of something - how fast blood sugar spikes after eating it. 
...
We have neural machinery to seek out sugary foods. [Parallel pathways](#TODO) exist for doing all kinds of things. To ensure behavior is done properly, usually more than one pathway exists to make things work. 
...
[Neuropod cells](#TODO), neurons in the gut that respond to presence of sugar in the gut. They send signals because of sugars via the vagus nerve, which plays a role in relaxation among other things, [nodos ganglion](#TODO) and then from there to the [nucleus of the solitary tract](#TODO). And of course also to the [mesolimbic pathway](#TODO). 
